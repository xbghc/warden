...
/**
 * Right-hand rail: the two things the reviewer writes — line comments, and the branch's todos, which
 * can carry comments with them to the agent. It is shut by default and costs nothing when it is: 360px is most of the code
